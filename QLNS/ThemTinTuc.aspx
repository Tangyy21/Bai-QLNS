<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="ThemTinTuc.aspx.cs" Inherits="QLNS.ThemTinTuc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="dsTinTuc" runat="server"
        ConnectionString="<%$ ConnectionStrings:TinTucDBConnectionString %>" 
        SelectCommand="SELECT * FROM [BanTin]" OnClick="dsTinTuc_Click"></asp:SqlDataSource>
</asp:Content>
